...
ที่เก็บนี้เป็น**เอกสารประกอบระบบ** — อธิบายว่าระบบทำอะไรได้ ต้องใช้อะไร และติดตั้งอย่างไร

ซอร์สโค้ดฉบับเต็มไม่ได้เผยแพร่ที่นี่ เพราะระบบผูกกับโครงสร้างข้อมูลของ HosXP
